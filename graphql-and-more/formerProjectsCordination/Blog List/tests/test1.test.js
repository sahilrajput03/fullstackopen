...
describe("total likes", () => {
  test("of empty list_is_zero", () => {
    console.log("yess..there you goo");
    console.log("yess..there you goo again");
  ...
  test("Checking for blogger with max blogs", () => {
    ...
    expect(listHelper.authorWithMaxBlogs(blogslist_many)).toEqual(
      mostBlogsAuthor
    );
  });
  ...
  test("author with most likes on single blogpost", () => {
    expect(listHelper.mostLikesonsingleblog(blogslist_many)).toEqual(
      mostlikeblogger
    );
  });
  ...
  test("author with most likes cumulatively", () => {
    expect(listHelper.mostLikes(blogslist_many)).toEqual(
      mostlikebloggerToalLikes
    );
  });
});
